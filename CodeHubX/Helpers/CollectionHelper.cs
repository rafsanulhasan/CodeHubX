...
namespace CodeHubX.Helpers
{
	...
	{
		public static ICollection Combine(this ICollection collection, ICollection combinableCollection)
		{
			if (collection == null)
			{
		...
		public static ICollection<T> Combine<T>(this ICollection<T> collection, ICollection<T> combinableCollection)
		{
			if (collection == null)
			{
				throw new ArgumentNullException(nameof(collection));
		...
		public static ReadOnlyObservableCollection<T> ToReadOnlyObservableCollection<T>(this ObservableCollection<T> collection) 
