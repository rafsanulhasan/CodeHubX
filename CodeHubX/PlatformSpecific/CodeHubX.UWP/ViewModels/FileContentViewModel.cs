...
using CodeHubX.UWP.Services.Hilite_me;
...
namespace CodeHubX.UWP.ViewModels
{
	public class FileContentViewmodel : AppViewmodel
	{
		...
		private ImageSource _imageFile;
		...
		private Color _HTMLBackgroundColor = SettingsService.Get<bool>(SettingsKeys.AppLightThemeEnabled) ? Colors.White : Colors.Black;
		/// <summary>
			...
			if (GlobalHelper.IsInternet())
			{
				    ...
				    Path.ToLower().EndsWith(".gif"))
				{
					...
					*/
					...
					if (!StringHelper.IsNullOrEmptyOrWhiteSpace(uri))
