...
namespace CodeHubX.UWP.ViewModels.Settings
{
	...
	{
		private bool _HideSystemTray = SettingsService.Get<bool>(SettingsKeys.HideSystemTray);

		private bool _AppLightThemeEnabled = SettingsService.Get<bool>(SettingsKeys.AppLightThemeEnabled);
		/// <summary>
		...
		public SyntaxHighlightStyleEnum HighlightStyle
			=> (SyntaxHighlightStyleEnum) SelectedHighlightStyleIndex;
		...
		private int _SelectedHighlightStyleIndex = SettingsService.Get<int>(SettingsKeys.HighlightStyleIndex);
		/// <summary>
		...
		private bool _ShowLineNumbers = SettingsService.Get<bool>(SettingsKeys.ShowLineNumbers);
		/// <summary>
