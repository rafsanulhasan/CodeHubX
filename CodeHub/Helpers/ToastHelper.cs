...
namespace CodeHub.Helpers
{
	...
	public static class ToastHelper
	{
		...
		public static ToastNotification PopCustomToast(ToastNotification notification) => PopCustomToast(notification, null, null);
		...
		[DefaultOverload]
		public static ToastNotification PopCustomToast(XmlDocument doc) => PopCustomToast(new ToastNotification(doc), null, null);
		...
		public static async Task<bool> Like(this ToastNotification toast, Octokit.Notification notification) => toast.Like(await notification.BuildToast(ToastNotificationScenario.Reminder));

		public static bool Like(this ToastNotification toast, ToastNotification toast2) => toast.Tag == toast2.Tag && toast.Group == toast2.Group;
	}
}
