...
using static CodeHub.Helpers.OctokitNotificationHelper;
using static CodeHub.Helpers.ValueSetHelper;
using AppViewmodel = CodeHub.ViewModels.AppViewmodel;
using BadgeHelper = CodeHub.Helpers.BadgeHelper;
using Messenger = GalaSoft.MvvmLight.Messaging.Messenger;
using NotificationsViewmodel = CodeHub.ViewModels.NotificationsViewmodel;
using TilesHelper = CodeHub.Helpers.TilesHelper;
using ToastHelper = CodeHub.Helpers.ToastHelper;
